...
void show_command_help(BicycleStr command_name)
{
    ...
    case 2:
        ...
        cout << "Если границы будущей подстроки выходят за пределы\nизначальной строки, то она будет обрезана, вплоть до пустой (\"\")." << endl;
        cout << "Будьте внимательны при использовании этого параметра\n вместе с параметром -spl. Очередность имеет значение!\n" << endl;
    ...
    case 3:
        ...
        cout << "Будьте внимательны при использовании этого параметра\n вместе с параметром -sub. Очередность имеет значение!\n" << endl;
